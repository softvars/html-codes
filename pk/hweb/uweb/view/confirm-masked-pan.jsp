...
<tiles:insertDefinition name="registrationlayout">
	...
	Hype Wallet - Conferma carta
</tiles:putAttribute>
	<tiles:putAttribute name="javascript">
		<script type="text/javascript">
			var maskedCardValues = JSON.parse('${maskedCardValues}');
		</script>
		<script type="text/javascript" src="<c:url value="/resources/js/controller/maskedcardconfirm.js"/>"></script>
	</tiles:putAttribute>
			...
			<div class="col-lg-4 col-lg-offset-4 col-md-5 col-md-offset-4 col-sm-6 col-sm-offset-3">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="sub-head">Utilizzi gi&#224; l&#39;applicazione Hype Wallet.</div>
				<div class="sub-head">Scegli una delle tue carte e inserisci le
				...
				<div class="row">
					<div class="col-sm-12">
						<form method="POST" class="address-form confirm-card-form" action="" id="confirm-maskedpan-form">
							<div class="row">
								<fieldset>
									...
									<div class="flipper">
										<div class="card-plate front">
											...
											<div class="middle">
												...
												<div class="card-code code-4">****</div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-xs-12">
									<label>Inserisci la cifra n° x, n° x, n° x e n° x
										della carta.</label>
								</div>
								<div class="input-group-block">
									<div class="col-xs-3">
										<input type="text" class="text-input masked-pan-value" name="cfrOne" id="cfr1"  placeholder="*" />
									</div>
									<div class="col-xs-3">
										<input type="text" class="text-input masked-pan-value" name="cfrTwo" id="cfr2" placeholder="*"  />
									</div>
									<div class="col-xs-3">
										<input type="text" class="text-input masked-pan-value" name="cfrThree" id="cfr3" placeholder="*" />
									</div>
									<div class="col-xs-3">
										<input type="text" class="text-input masked-pan-value" name="cfrFour" id="cfr4" placeholder="*"  />
									</div>
									<div class="input-msg masked-pan-msg"></div>
								</div>
							</div>
							<fieldset>
								<input type="submit" name="send" value="CONFERMA" id="confirm-maskedpan-btn" />
