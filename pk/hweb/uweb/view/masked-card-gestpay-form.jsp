	...
	<div
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="card sub-head"> <span>Inserisci le cifre mancanti della carta </br>${maskedGestpayCardForVerification.cardLabel} </br>che hai richiesto di registrare </div>
		...
		<div class="row">
			<div class="col-sm-12">
				<form method="POST" class="address-form confirm-card-form" action=""
					...
					<div class="row">
								<c:if
									test="${true == isAliasRequired}">
						<fieldset>
							<div class="input-group alias-name">
								<input type="text" class="text-input alias-name" name="cardAlias"
									id="card-name" placeholder="Nome carta di credito" /> <span
									class="input-group-btn"> <span class="input-group-addon"></span>
								</span>
					...
					<div class="credit-card">
						<div class="flip-container" id="card-container-1">
							<div class="flipper">
								<div class="card-plate front margin gestpay">
									<div class="top">
										<div class="chip"></div>
										<div class="type">
					...
					<fieldset>
						<input type="submit" name="send" value="CONFERMA"
							id="confirm-gestpay-maskedpan-btn" />
