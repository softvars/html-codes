...
<div class="container form-content" id="modal-preregister-user">
	<div
		...
		<div class="row userprofile-form">
			<div class="col-sm-12">
				<form class="registration-user-form" id="registration-user-form"
					...
					<fieldset>
						...
						<div class="input-group">
							<input type="text" name="firstName" id="name" placeholder="Nome"
					...
					<fieldset>
						...
						<div class="input-group">
							<input type="text" name="email" id="email" class="readonly"
					...
					<fieldset>
						...
						<div class="input-group birthdate">
							<input type="text" placeholder="GG/MM/AAAA" name="birthDate"
								 id="edit-date"
								picker-bind="birthDate__datepicker" /> <span
								class="input-group-btn"> <span class="input-group-addon"></span>
							</span>
							<div class="input-msg"></div>
						</div>
						...
						<div class="input-group-block security-question">
							<select name="securityQuestionOne" id="quest1"
								...
								<c:forEach items="${securityQuestions}" var="securityQuestion">
									<option value="${securityQuestion.code}">${securityQuestion.question}</option>
								</c:forEach>
							</select>
							<div class="input-msg"></div>
						</div>
