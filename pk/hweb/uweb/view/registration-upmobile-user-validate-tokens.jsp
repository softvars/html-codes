...
<tiles:insertDefinition name="registrationlayout">
	...
	<tiles:putAttribute name="javascript">
		<script type="text/javascript" src="<c:url value="/resources/js/controller/registration-validate-tokens.js"/>"></script>
	</tiles:putAttribute>
				...
				<div class="row">
					<div class="col-sm-12">
						<form method="POST" class="address-form confirm-token-form" id="token-validation-form"  action="#validateTokens">
							...
							<fieldset>
								<input type="submit" name="send" value="CONFERMA" id="upmobile-user-token-validation-btn" />
