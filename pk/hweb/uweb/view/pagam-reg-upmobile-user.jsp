...
<tiles:insertDefinition name="pagam.new.registration">
	...
	<tiles:putAttribute name="javascript">
		...
		<script type="text/javascript"
			src="<c:url value="/resources/js/controller/pagam-reg-upmobile-user.js"/>"></script>
	</tiles:putAttribute>
				...
				<div class="row">
					<div class="col-sm-12">
						<form
							...
							<fieldset>
								...
								<div class="input-group-block">
									<input type="text" name="email" id="email"
										...
										value="${userProfile.email}" class="input-group-btn" />
									<div class="input-msg"></div>
								</div>
							</fieldset>
							...
							<fieldset>
								...
								<div class="input-group">
									...
									<div class="col-xs-9 less-padding-left padding-right-zero">
										<p class="input-group">
											<input type="text" name="mobileNumber" id="phone" value="${userProfile.mobileNumber}"
												placeholder="Cellulare" class="text-input" /> <span
												class="input-group-btn"> <span
												class="input-group-addon"></span>
											</span>
										</p>
							...
							<c:choose>
								<c:when
									test="${userProfile.taxCode ne null && userProfile.taxCode ne ''}">
									<fieldset>
										<label for="edit-date">data di nascita</label>
										<div class="input-group-block birthdate">
											<input type="text" value="${userProfile.birthDate}"
												class="readonly" readonly placeholder="GG/MM/AAAA"
												name="birthDate" id="edit-date"
									...
									<fieldset>
										...
										<div class="input-group">
											<input type="text" name="taxCode" id="cf"
												...
												class="text-input edit_codice_fiscale" value="${userProfile.taxCode}" /> <span
												class="input-group-btn"> <span
												class="input-group-addon"></span>
											</span>
											<div class="input-msg"></div>
								...
								<c:otherwise>
									<fieldset>
										...
										<div class="input-group birthdate">
											<input type="text" placeholder="GG/MM/AAAA" name="birthDate" value="${userProfile.birthDate}"
								...
								<div class="col-xs-12 less-padding-right">
									<div class="checkbox reg">
										<input id="termsAndCondition" type="checkbox"
											...
											href="#termini_e_condizioni" id="termsAndConditionModal">
												<span>TERMINI DI UTILIZZO E LE CONDIZIONI SULLA
													PRIVACY </span>
										</a></label>
									</div>
								</div>
	...
	<tiles:putAttribute name="terms-and-conditions-privacy-policy">
		<%@ include
			file="/WEB-INF/layout/terms-conditions-and-privacy-policy.jsp"%>
	</tiles:putAttribute>
