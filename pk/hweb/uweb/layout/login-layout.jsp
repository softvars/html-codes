...
<head>
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/controller/login.js"/>"></script>
...
<body>
	...
	<c:if test="${registration_status == 'success'}">
			    <div class="confirm-modal hide-it" style="display:none" id="registration-success-alert">
			        <div class="popover hype-wallet-alert button-middle registered-user">
			            <div class="popover-title">
			                <span>Registrazione Avvenuta</span>
			            </div>
			            <div class="popover-content">
			                <span>Accedi subito al tuo profilo HYPE WALLET.</span>
			            </div>
			            <div class="popover-actions row">
			                <div class="positive col-xs-12" id="do-login-on-registration-success">
			                    <a href="dologinonregistrationsuccess?secrandid=${secrandid}" >OK</a>
			                </div>
			            </div>
			        </div>
			    </div>
	...
	<div class="sticky-footer">
		<div class="col-sm-12">
			<div class="copyright">
                ...
                <span class="terms" id="privacy-policy">
