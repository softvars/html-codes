...
my_http.createServer(function(request,response){
    ...
    if(isAPIRequest) {
       if(requrl.startsWith("/api/product/add")) {
            var body = "";
            ...
            request.on('end', function () {
                ...
                console.log("The request end arguments is :" + arguments[0] +":"+ arguments[1]+":" + arguments[2] + ";" +  arguments[3]);
                products.insert(JSON.parse(body));
