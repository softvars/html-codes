...
// Contiene PATCH da per https://issues.apache.org/jira/browse/CB-6911 https://git-wip-us.apache.org/repos/asf?p=cordova-js.git;h=6c7a76f
...
function replaceNavigator(origNavigator) {
    ...
    if (CordovaNavigator.bind) {
        for (var key in origNavigator) {
            ...
            } else { //Cherrypick per https://issues.apache.org/jira/browse/CB-6911 https://git-wip-us.apache.org/repos/asf?p=cordova-js.git;h=6c7a76f
                (function(k) {
