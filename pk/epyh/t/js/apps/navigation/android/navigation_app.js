define(["app", "apps/navigation/android/list/list_controller"], function (Appersonam, ListController) {
            ...
            launchApp: function (functionName) {
                require(["entities/user"], function () {
                    ...
                    $.when(fetchingPrimaryEmail).done(function (primaryEmail) {
                        ...
                        AppToAppPlugin.launchApp(null, null, functionName, { userId: primaryEmail });
                    });
                });
            }
        };
